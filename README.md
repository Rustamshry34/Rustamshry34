...
**Core Skills:**  
`NLP` · `LLMs` · `Fine-tuning (LoRA / QLoRA)` · `RAG` · `Vector Databases` · `AI Agents` · `Deep Learning` · `Reinforcement Learning`
...
<p>
<img align="left" src="https://github-readme-stats.vercel.app/api/top-langs?username=Rustamshry34&show_icons=true&layout=compact" />
</p>
